...
public class GameSound {
	JTextField name[] = { // sound의 경로를 저장하는 TextField
			...
			new JTextField("C:\\Users\\User\\Desktop\\Anipang\\anipang\\선택불가능할때.wav"), // Game - swap 불가 소리
			new JTextField("C:\\Users\\User\\Desktop\\Anipang\\anipang\\아이템생길때.wav"), // Game - 아이템 생길때 소리
			new JTextField("C:\\Users\\User\\Desktop\\Anipang\\anipang\\아이템쓸때2.wav") // Game - 아이템 사용시 소리
			};
